...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <a href="?view=all" class="sidebar-brand">
            <i class="bi bi-calendar2-check-fill"></i> Dispatch Center
        </a>
    ...
    <div class="px-4 py-3 border-bottom border-secondary border-opacity-10 bg-black bg-opacity-10">
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="overflow-hidden">
                <div class="fw-bold text-white text-truncate" style="font-size: 0.8rem;"><?= htmlspecialchars($admin_nama) ?></div>
    ...
    <div class="nav-section">
        ...
        <nav class="nav flex-column">
            <a class="nav-link <?= $view=='all'?'active':'' ?>" href="?view=all&tanggal=<?=htmlspecialchars($tgl)?>">
            ...
            <!-- MENU TIKET OPEN -->
    <a class="nav-link <?= $view=='open'?'active':'' ?>" href="?view=open&tanggal=<?=htmlspecialchars($tgl)?>">
     <span>
...
<a class="nav-link <?= $view=='dispatched'?'active':'' ?>" href="?view=dispatched&tanggal=<?=htmlspecialchars($tgl)?>">
    <span>
    ...
    <?php endif; ?>
            ...
            <a class="nav-link <?= $view=='closed'?'active':'' ?>" href="?view=closed&tanggal=<?=htmlspecialchars($tgl)?>">
                <span>
